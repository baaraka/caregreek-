        ...
        <div className="teamDiv">
          <div className="teamHeading">
            ...
            <p className="teamParagraph">
              ...
              Meets The High Standards Set And Expected By The Regulators And
              That The Company Is Committed To Make Faith Effort To Resolve Any
              Consumer Issues.
            </p>
          </div>
